...
export class UnderVideoFunctionProvider extends FunctionProvider {
    ...
    private showTabletOperatorCallback?: (state: ActionState) => void =
        undefined;
    /**
     * Callback function to update the selected location scaled XY in the operator
     * interface.
     */
     ...
     *
     * @param callback operator's callback function to update move to pregrasp state
     */
    ...
    /**
     * Sets the local pointer to the operator's callback function, to be called
     * whenever the move to point state changes.
     *
    ...
    /**
     * Sets the local pointer to the operator's callback function, to be called
     * whenever the selected location scaled XY needs to be updated.
     *
