...
echo "Run webpack..."
export NODE_EXTRA_CA_CERTS="/home/hello-robot/ament_ws/src/nrc_web_teleop/certificates/rootCA.pem"
cd ~/ament_ws/src/nrc_web_teleop && pm2 start -s npm --name="nrc_web_teleop" -- run $STORAGE &>> $REDIRECT_LOGFILE

echo "Start local server..."
cd ~/ament_ws/src/nrc_web_teleop && pm2 start -s server.js --watch &>> $REDIRECT_LOGFILE

echo "Start robot browser..."
cd ~/ament_ws/src/nrc_web_teleop && pm2 start -s start_robot_browser.js --watch &>> $REDIRECT_LOGFILE
